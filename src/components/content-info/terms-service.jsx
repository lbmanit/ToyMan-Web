    ...
    <section className='content-info text-base'>
      <div className='container m-auto'>
        <div className='flex justify-between'>
          ...
          <i className='fas fa-times' onClick={props.displayTerms}></i>
        </div>
        <div>
          <h1 className='text-2xl font-bold'>OVERVIEW</h1>
          <p>
            This website is operated by Drou. Throughout the site, the terms
            “we”, “us” and “our” refer to Drou. Drou offers this website,
        ...
        <div>
          <h1 className='text-2xl font-bold'>SECTION 1 - ONLINE STORE TERMS</h1>
          <p>
        ...
        <div>
          <h1 className='text-2xl font-bold'>SECTION 2 - GENERAL CONDITIONS</h1>
          <p>
        ...
        <div>
          <h1 className='text-2xl font-bold'>SECTION 7 - OPTIONAL TOOLS</h1>
          <p>
          ...
          <p>
            ...
            optional third-party tools. Any use by you of the optional tools
        ...
        <div>
          <h1 className='text-2xl font-bold'>SECTION 12 - PROHIBITED USES</h1>
          <p>
        ...
        <div>
          ...
          <p>
            ...
            case shall Drou, our directors, officers, employees, affiliates,
        ...
        <div>
          <h1 className='text-2xl font-bold'>SECTION 14 - INDEMNIFICATION</h1>
          <p>
            You agree to indemnify, defend and hold harmless Drou and our
        ...
        <div>
          <h1 className='text-2xl font-bold'>SECTION 15 - SEVERABILITY</h1>
          <p>
        ...
        <div>
          <h1 className='text-2xl font-bold'>SECTION 16 - TERMINATION</h1>
          <p>
        ...
        <div>
          <h1 className='text-2xl font-bold'>SECTION 17 - ENTIRE AGREEMENT</h1>
          <p>
